...
function CfApp() {
  ...
  const HEADLINES = [
    ...
    },
    {
      ...
      sub: <>The next move is yours. Show up on time, bring three numbers (we list them below), and walk away with a model for how Newly Booked would add <em>$150K–$300K</em> in new patient revenue to your spa.</>,
    },
  ];
